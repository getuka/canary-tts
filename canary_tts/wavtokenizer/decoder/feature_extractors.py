...
from canary_tts.wavtokenizer.encoder.modules import SEANetEncoder, SEANetDecoder
from canary_tts.wavtokenizer.encoder import EncodecModel
from canary_tts.wavtokenizer.encoder.quantization import ResidualVectorQuantizer
...
class EncodecFeatures(FeatureExtractor):
    ...
    def forward(self, audio: torch.Tensor, bandwidth_id: torch.Tensor):
        if self.canary_tts.wavtokenizer:
            self.encodec.train()
